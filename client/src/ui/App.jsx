...
function AppContent() {
  ...
  const [selectedModel, setSelectedModel] = useState(() => localStorage.getItem('selectedModel') || 'gemini-2.0-flash');
        ...
        <div className="nav-links">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginLeft: '8px' }}>
            <select
              ...
              title="Select Free Gemini Model (Zero API Cost)"
            >
